...
namespace _2WBMR_UI_ver2
{
    public partial class RobotSystemConfig : Form
    {
        ...
        private _2WBMR_UI_ver2 mainForm;
        ...
        public RobotSystemConfig(_2WBMR_UI_ver2 mainForm)
        {
            InitializeComponent();
        ...
        private void SendShortFrame(byte startByte, byte endByte, int DataType, int Index, ushort dataSend)
        {
            ...
            mainForm.serCOM.Write(transBuff, 0, 8);
            Console.Write($"Checksum = {transBuff[6]} \n");
        }
        private void SendLongFrame(byte startByte, byte endByte, int DataType, List<TextBox> txtDataType)
        {
            // Frame 11 BYTES {0: start/ 1: dữ liệu loại ()/ 2: loại frame/ 3-8: 6 byte dữ liệu/ 9: checksum/ 10: end}
            byte[] transBuff = new byte[11];
            transBuff[0] = startByte; transBuff[10] = endByte;
            ...
            transBuff[9] = (byte)Modbus_CRC16(transBuff, 11, 0, 8);
            mainForm.serCOM.Write(transBuff, 0, 11);
            Console.Write($"Checksum = {transBuff[9]} \n");
        }
